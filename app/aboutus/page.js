          ...
          <div className="text-center mb-12">
            ...
            <div className="flex flex-wrap justify-center gap-8 mt-8">
              ...
              <div className="w-64 bg-white shadow-lg rounded-lg overflow-hidden">
                <img className="w-full h-64 object-cover" src="/images/team1.jpg" alt="Team Member 1" />
              ...
              {/* Team Member 2 */}
              <div className="w-64 bg-white shadow-lg rounded-lg overflow-hidden">
                <img className="w-full h-64 object-cover" src="/images/team2.jpg" alt="Team Member 2" />
                <div className="p-6 text-center">
              ...
              {/* Team Member 3 */}
              <div className="w-64 bg-white shadow-lg rounded-lg overflow-hidden">
                <img className="w-full h-64 object-cover" src="/images/team3.jpg" alt="Team Member 3" />
                <div className="p-6 text-center">
